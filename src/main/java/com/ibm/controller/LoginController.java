...
import com.ibm.jwtconfig.AuthManager;
import com.ibm.jwtconfig.JwtTokenProvider;
import com.ibm.jwtconfig.UserPrincipal;
import com.ibm.model.User;
import com.ibm.pojo.ApiResponse;
import com.ibm.pojo.LoginRequest;
...
public class LoginController {
	...
	/*
	 * @PostMapping("/insert") public OrderItem createOrder(@RequestBody OrderItem
	 * order) { return repo.save(order); }
	 */

	@GetMapping("login/user")//post and get
	public ResponseEntity<?> userLogin(@RequestBody LoginRequest loginRequest) {
		
		try {
			
        	Authentication authentication =  aMan.authenticate(new UsernamePasswordAuthenticationToken(loginRequest.getLoginID(), loginRequest.getPassword()) ,loginRequest);
