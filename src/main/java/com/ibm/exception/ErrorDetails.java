...
public class ErrorDetails {
	...
	/*
	 * public ErrorDetails(String errorCode, String errorDetails, LocalDateTime
	 * timestamp, List<FieldError> errorFields) { super(); this.errorCode =
	 * errorCode; this.errorDetails = errorDetails; this.timestamp = timestamp;
